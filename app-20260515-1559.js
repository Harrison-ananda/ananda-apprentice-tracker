...
async function loadStaffData() {
  const { data: staffAllowed, error: staffError } = await cloudClient.rpc("is_staff");
  ...
  const [{ data: apprenticeRows, error: apprenticeError }, { data: progressRows }, { data: questionRows }, { data: noteRows }, { data: resourceRows }] =
    await Promise.all([
